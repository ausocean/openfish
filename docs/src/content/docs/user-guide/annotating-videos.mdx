---
title: How to add annotations to a video
---
...
1.  #### Select a video stream to watch and annotate
    ...
    ![](../../../assets/screenshots/annotating-videos/1a.png)

    Select the stream you want to annotate

    ![](../../../assets/screenshots/annotating-videos/1b.png)

    This will bring you to the watch page.

    ![](../../../assets/screenshots/annotating-videos/1c.png)

2.  #### Add an annotation

    When you spot something you want to annotate, click on "Add annotation".

    ![](../../../assets/screenshots/annotating-videos/2a.png)
