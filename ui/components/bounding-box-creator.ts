...
export class BoundingBoxCreator extends TailwindElement {
  @property()
  accessor box: [number, number, number, number] | null = null
  ...
  endBox(ev: MouseEvent) {
    ...
    this.dispatchEvent(
      new CustomEvent('updateboundingbox', { detail: this.box }) as UpdateBoundingBoxEvent
    )
  }
